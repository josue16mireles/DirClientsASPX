<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="dir_clients.ClientsDir" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <dx:ASPxGridView runat="server" ID="GridView" ClientInstanceName="gridView" 
        ...
        <SettingsText PopupEditFormCaption="Editar Cliente" />
